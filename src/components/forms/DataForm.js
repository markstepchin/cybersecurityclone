            ...
            <React.Fragment>
                ...
                >
                    <CheckBoxInput
                        ...
                        onChange={() => this.setState(prevState => ({ encryptOnComputers: !prevState.encryptOnComputers }))}
                    />
                    <CheckBoxInput
                        label='Mobile Devices (laptops, cell phones, flash drives, tablets, etc.)'
                        checked={this.state.encryptOnMobile}
                        onChange={() => this.setState(prevState => ({ encryptOnMobile: !prevState.encryptOnMobile }))}
                    />
                    <CheckBoxInput
                        label='Networks'
                        checked={this.state.encryptOnNetworks}
                        onChange={() => this.setState(prevState => ({ encryptOnNetworks: !prevState.encryptOnNetworks }))}
                    />
                </CheckBoxGroup >
                ...
                >
                    <CheckBoxInput
                        ...
                        onChange={() => this.setState(prevState => ({ backupOnSite: !prevState.backupOnSite }))}
                    />
                    <CheckBoxInput
                        label='Offsite (physical storage)'
                        checked={this.state.backupOffSitePhysical}
                        onChange={() => this.setState(prevState => ({ backupOffSitePhysical: !prevState.backupOffSitePhysical }))}
                    />
                    <CheckBoxInput
                        label='Offsite (the Cloud)'
                        checked={this.state.backupOffSiteCloud}
                        onChange={() => this.setState(prevState => ({ backupOffSiteCloud: !prevState.backupOffSiteCloud }))}
                    />
                </CheckBoxGroup >
                ...
                >
                    <CheckBoxInput
                        ...
                        onChange={() => this.setState(prevState => ({ systemIntrustion: !prevState.systemIntrustion }))}
                    />
                    <CheckBoxInput
                        label='Tampering'
                    ...
                    <CheckBoxInput
                        ...
                        onChange={() => this.setState(prevState => ({ codeAttacks: !prevState.codeAttacks }))}
                    />
                    <CheckBoxInput
                        label='Loss of Data'
                        checked={this.state.lossOfData}
                        onChange={() => this.setState(prevState => ({ lossOfData: !prevState.lossOfData }))}
                    />
                    <CheckBoxInput
                        label='Loss of portable media'
                        checked={this.state.lossOfMedia}
                        onChange={() => this.setState(prevState => ({ lossOfMedia: !prevState.lossOfMedia }))}
                    />
                    <CheckBoxInput
                        label='Hacking incident'
                        checked={this.state.hackingIncident}
                        onChange={() => this.setState(prevState => ({ hackingIncident: !prevState.hackingIncident }))}
                    />
                    <CheckBoxInput
                        label='Extortion attempt'
                        checked={this.state.extortionAttempt}
                        onChange={() => this.setState(prevState => ({ extortionAttempt: !prevState.extortionAttempt }))}
                    />
                    <CheckBoxInput
                        label='Data theft'
                    ...
                    <CheckBoxInput
                        ...
                        onChange={() => this.setState(prevState => ({ copyrightDispute: !prevState.copyrightDispute }))}
                    />
                </CheckBoxGroup >
                ...
                >
                    ...
                    <CheckBoxInput
                        ...
                        onChange={() => this.setState(prevState => ({ incomeLoss: !prevState.incomeLoss }))}
                    />
                    <CheckBoxInput
                        label='Threatened or actual legal action'
                        checked={this.state.legalThreat}
                        onChange={() => this.setState(prevState => ({ legalThreat: !prevState.legalThreat }))}
                    />
                    <CheckBoxInput
                        label='Actual insurance claim'
                        checked={this.state.actualInsuranceClaim}
                        onChange={() => this.setState(prevState => ({ actualInsuranceClaim: !prevState.actualInsuranceClaim }))}
                    />
                    <CheckBoxInput
